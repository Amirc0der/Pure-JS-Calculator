const timerlength = 10000 // Change it if you want to change the autoslide speed (in miliseconds, 10000 means 10 seconds) 
...
function slideTimerR (){
	if (currentSlider > 0) { 
		slidePrevius ()
		window.setTimeout (slideTimerR, timerlength) 
	} else {
		slideTimer()
	}
}
